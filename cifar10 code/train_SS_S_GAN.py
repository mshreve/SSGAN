...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 27 10:41:04 2017
...
nlab = 100       # # number of labeled examples
alpha = 1.0
offset = 00000
...
dwy = difn((ndf*8*4*1, 1), 'dwy'); dwq = difn((ndf*8*4*1, 1), 'dwq')
...
d_cost_s = d_cost_real_l + (1*d_cost_gen_l + 1*d_cost_match)/2. #+ a#((1-a)*d_cost_match + 1*d_cost_gen_l)/2.
