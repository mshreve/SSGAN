...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 22 10:29:56 2017
...
def load_data():
    ...
    ys = []
    for j in range(5):
      d = unpickle('cifar-10-batches-py/data_batch_'+`j+1`)#+'_100')
      x = d['data']
      y = d['labels']
      xs.append(x)
      ys.append(y)

    d = unpickle('cifar-10-batches-py/ss_syn_test_batch_4000')
    xs.append(d['data'])
    ys.append(d['labels'])
...
def main(n=5, num_epochs=250, model=None):
