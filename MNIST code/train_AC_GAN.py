...
def AC_GAN(args): 
    ...
    #desc = 'mnist_semisup_AC_dcgan'
    desc = 'mnist_ACgan_'+str(args.count)+'_'+str(alpha)+'_'+str(args.seed)+'_'+str(args.seed_data)
    ...
    for epoch in range(niter):
        vaX, vaY = shuffle(vaX, vaY); vaYshuffle = shuffle(vaY);
