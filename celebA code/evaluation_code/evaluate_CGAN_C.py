...
sm_gX_small = gen(Z, Y, *sm_gen_params)
sm_gen_small = theano.function([Z, Y], sm_gX_small, on_unused_input='ignore')
...
s_samples_small = np.asarray(sm_gen_small(sm_sample_zmb, sample_ymb))
