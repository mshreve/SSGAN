...
code for evaluating GAN's - create a atrribute prediction model and evaluate. 
"""
...
print np.sqrt(np.mean((true_pred-sample_ymb)**2))
print np.sqrt(np.mean((ac_pred-sample_ymb)**2))
print np.sqrt(np.mean((am_pred-sample_ymb)**2))
print np.sqrt(np.mean((ss_pred-sample_ymb)**2))
print np.sqrt(np.mean((s_pred_small-sample_ymb)**2))
print np.sqrt(np.mean((s_pred-sample_ymb)**2))
